...
import EasyPrivateVotingContractArtifactJson from '../../target/token_contract-EasyPrivateVoting.json' with { type: 'json' };
...
export class EasyPrivateVotingContract extends ContractBase {
  ...
  public static get storage(): ContractStorageLayout<'admin' | 'tally' | 'vote_ended' | 'active_at_block' | 'pause_module' | 'issuer_address' | 'balances' | 'total_supply' | 'symbol' | 'name' | 'decimals'> {
      return {
        admin: {
      slot: new Fr(1n),
    },
...
decimals: {
      ...
      } as ContractStorageLayout<'admin' | 'tally' | 'vote_ended' | 'active_at_block' | 'pause_module' | 'issuer_address' | 'balances' | 'total_supply' | 'symbol' | 'name' | 'decimals'>;
    }
