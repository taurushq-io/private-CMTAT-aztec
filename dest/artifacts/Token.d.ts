import { AztecAddress, AztecAddressLike, ContractArtifact, ContractBase, ContractFunctionInteraction, ContractMethod, ContractStorageLayout, ContractNotes, DeployMethod, FieldLike, Fr, Wallet } from '@aztec/aztec.js';
...
export declare class TokenContract extends ContractBase {
     ...
     */
    static deployWithPublicKeysHash(publicKeysHash: Fr, wallet: Wallet, admin: AztecAddressLike): DeployMethod<TokenContract>;
    /**
    ...
    static get notes(): ContractNotes<'TokenNote' | 'TransparentNote'>;
